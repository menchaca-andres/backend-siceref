...
router.post('/', verificarToken, autorizar('refugios:crear'), uploadImage.single('img_ref'), RefugioController.create)
router.put('/:id', verificarToken, autorizarAlguno('refugio:modificar:propio', 'refugios:modificar'), autorizarRefugioPropioOPermiso('refugios:modificar'), uploadImage.single('img_ref'), RefugioController.update)
