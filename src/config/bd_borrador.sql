...
DROP TABLE IF EXISTS LOGS_USUARIO;
...
CREATE TABLE LOGS_USUARIO (
    ...
    CONSTRAINT LOGS_USUARIO_USUARIOS_fk FOREIGN KEY (id_usu) REFERENCES USUARIOS (id_usu) ON DELETE SET NULL
);
